...
public class User : BaseEntity, IUser
{
    ...
    /// <summary>
    /// List of sales where this user acted as a Customer.
    /// </summary>
    public List<Sale> Purchases { get; private set; } = new List<Sale>();

    /// <summary>
    /// List of sales where this user acted as a Manager/Admin registering a sale.
    /// </summary>
    public List<Sale> RegisteredSales { get; private set; } = new List<Sale>();
    ...
    /// <summary>
    /// Checks if the user can register sales (Manager/Admin).
    /// </summary>
    public bool CanRegisterSales => Role == UserRole.Manager || Role == UserRole.Admin;
